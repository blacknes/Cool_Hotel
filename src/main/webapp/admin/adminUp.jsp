...
<script type="text/javascript" charset="utf-8">
	...
	var logoutFun = function() {
		$.post('${pageContext.request.contextPath}/base/user!doNotNeedSessionAndSecurity_logout.action', function(result) {
			location.replace('${pageContext.request.contextPath}/securityLogin.jsp');
		}, 'json');
	};
	var showMyInfoFun = function() {
		var dialog = parent.sy.modalDialog({
			title : '我的信息',
			url : '${pageContext.request.contextPath}/admin/userInfo.jsp'
		});
	};
</script>
<div id="sessionInfoDiv" style="position: absolute; right: 10px; top: 5px;">
	<%
		if (sessionInfo != null) {
			out.print(nill.utils.StringUtil.formateString("欢迎您，{0}", sessionInfo.getUser().getLoginname()));
		}
	%>
</div>
