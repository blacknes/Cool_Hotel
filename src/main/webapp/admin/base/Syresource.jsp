...
<script type="text/javascript">
	...
	var addFun = function() {
		var dialog = parent.sy.modalDialog({
			title : '添加资源信息',
			url : sy.contextPath + '/admin/base/SyresourceForm.jsp',
			buttons : [ {
				text : '添加',
				handler : function() {
	...
	var showFun = function(id) {
		var dialog = parent.sy.modalDialog({
			title : '查看资源信息',
			url : sy.contextPath + '/admin/base/SyresourceForm.jsp?id=' + id
		});
	};
	...
	var removeFun = function(id) {
		parent.$.messager.confirm('询问', '您确定要删除此记录？', function(r) {
			if (r) {
				$.post(sy.contextPath + '/base/resource!delete.action', {
					id : id
				}, function() {
	...
	$(function() {
		grid = $('#grid').treegrid({
			title : '',
			url : sy.contextPath + '/base/resource!treeGrid.action',
			idField : 'id',
			treeField : 'name',
			parentField : 'pid',
			rownumbers : true,
